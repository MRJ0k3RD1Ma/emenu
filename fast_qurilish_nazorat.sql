...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2023 at 04:12 PM
...
--
-- Database: `fast_qurilish_nazorat`
--
...
INSERT INTO `user` (`id`, `name`, `username`, `password`, `auth_key`, `token`, `code`, `access_token`, `created`, `updated`, `status`, `role_id`, `image`, `soato_id`, `phone`) VALUES
(4, 'Administrator', 'admin', '$2y$13$Hx9.Rv/1278Ap0H9MXMsEO6ghMsLP/6VZVaW4wJPTSSi85udZ6ili', NULL, NULL, NULL, NULL, '2023-10-19 17:03:20', '2023-10-19 17:03:20', 1, 100, 'default/avatar.png', 1733, '+998999670395');
...
(69, 'Tuman shatab', '/dsh/', 1),
(70, 'Tuman prokurori', '/dp/', 1),
(79, 'Viloyat shtab', '/rsh/', 1),
(80, 'Viloyat prokurori', '/rp/', 1),
(100, 'Superadmin', '/cp/', 1);
