...
<?php $this->beginPage() ?>
    ...
    <div class="header">
        ...
        <form class="header-search__form" action="<?= Yii::$app->urlManager->createUrl(['/site/search'])?>">
            <div class="header-search">
                <div class="header-search__icon">
                    <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M19.9469 19.6853L14.4196 14.158C15.6383 12.7361 16.3453 10.8962 16.3453 8.87671C16.3453 4.38843 12.7075 0.751709 8.22034 0.751709C3.73324 0.751709 0.130493 4.3896 0.130493 8.87671C0.130493 13.3638 3.768 17.0017 8.22034 17.0017C10.2391 17.0017 12.0817 16.2611 13.5016 15.0427L19.0289 20.5701C19.1852 20.6892 19.3453 20.7517 19.5055 20.7517C19.6657 20.7517 19.8253 20.6907 19.9473 20.5686C20.193 20.3259 20.193 19.9275 19.9469 19.6853ZM8.2555 15.7517C4.43128 15.7517 1.3805 12.6658 1.3805 8.87671C1.3805 5.08765 4.43128 2.00171 8.2555 2.00171C12.0797 2.00171 15.1305 5.05249 15.1305 8.87671C15.1305 12.7009 12.0446 15.7517 8.2555 15.7517Z" fill="#474747"/>
                    </svg>
                </div>
                <input type="text" name="q" placeholder="Ovqat nomini yozing" />
            </div>
        </form>
...
<div class="menu-bottom">
      <ul>
        ...
        <li>
          <a href="<?= Yii::$app->urlManager->createUrl(['/site/work-hour'])?>">
            <div class="menu-bottom__icon">
